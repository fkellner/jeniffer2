    ...
    extends TestCase
{
     ...
     */
    public RCDTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( RCDTest.class );
    }

    public void testRCD() throws IOException, DNGReadException, CompressionDecoderException
    {
        System.out.println("### RCD");
        Processor<BufferedImage> processor = new DemosaicingProcessor(InterpolationMethod.RCD, CFAPattern.RGGB, AccelerationStrategy.CPU_TILING_MT, new NopLogger());
        assertTrue(TestUtils.testProcessor(processor, "preprocessed-rggb.png", "rcd.png", false));

        System.out.println("### RCD MT");
        processor = new DemosaicingProcessor(InterpolationMethod.RCD, CFAPattern.RGGB, AccelerationStrategy.MULTITHREADING, new NopLogger());
        assertTrue(TestUtils.testProcessor(processor, "preprocessed-rggb.png", "rcd.png", false));
