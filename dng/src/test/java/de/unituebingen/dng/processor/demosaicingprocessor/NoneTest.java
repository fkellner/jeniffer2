    ...
    extends TestCase
{
     ...
     */
    public NoneTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( NoneTest.class );
    }

    public void testNone() throws IOException, DNGReadException, CompressionDecoderException
    {
        System.out.println("### None");
        Processor<BufferedImage> processor = new DemosaicingProcessor(InterpolationMethod.NONE, CFAPattern.RGGB, AccelerationStrategy.NONE, new NopLogger());
        assertTrue(TestUtils.testProcessor(processor, "preprocessed-rggb.png", "none.png", false));

        System.out.println("### None MT");
        processor = new DemosaicingProcessor(InterpolationMethod.NONE, CFAPattern.RGGB, AccelerationStrategy.MULTITHREADING, new NopLogger());
        assertTrue(TestUtils.testProcessor(processor, "preprocessed-rggb.png", "none.png", false));
