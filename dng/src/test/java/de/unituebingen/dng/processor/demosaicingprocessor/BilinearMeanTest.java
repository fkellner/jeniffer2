    ...
    extends TestCase
{
     ...
     */
    public BilinearMeanTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( BilinearMeanTest.class );
    }

    public void testBilinearMean() throws IOException, DNGReadException, CompressionDecoderException
    {
        System.out.println("### Bilinear Mean");
        Processor<BufferedImage> processor = new DemosaicingProcessor(InterpolationMethod.BILINEAR_MEAN, CFAPattern.RGGB, AccelerationStrategy.CPU_TILING_MT, new NopLogger());
        assertTrue(TestUtils.testProcessor(processor, "preprocessed-rggb.png", "bilinear-mean.png", false));

        System.out.println("### Bilinear Mean MT");
