...
public class CsvAndConsoleLogger implements Timer {
    // singleton
    private static CsvAndConsoleLogger logger;

    private CsvAndConsoleLogger() {
        System.out.println("#### Starting CSV and Console logger");
    ...
    public static CsvAndConsoleLogger getInstance() {
        if (logger == null)
            logger = new CsvAndConsoleLogger();
        return logger;
    }
